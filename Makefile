...
debug: CFLAGS = -g -O0
debug: $(BIN_DIR)/pakman_debug.x86_64

release: CFLAGS = -O2
release: $(BIN_DIR)/pakman.x86_64
...
$(BIN_DIR)/pakman_debug.x86_64: $(patsubst $(SRC_DIR)/%.c,$(BIN_DIR)/obj/debug/%.o,$(SOURCES)) | $(BIN_DIR)
	$(CC) $(CFLAGS) $^ -o $@

$(BIN_DIR)/pakman.x86_64: $(patsubst $(SRC_DIR)/%.c,$(BIN_DIR)/obj/release/%.o,$(SOURCES)) | $(BIN_DIR)
	$(CC) $(CFLAGS) $^ -o $@
